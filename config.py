...
# ── Knowledge Graph ───────────────────────────────────────────────────────────
SKILL_CATEGORIES = {
    "programming": ["Python", "Java", "JavaScript", "TypeScript", "C++", "Go", "Rust", "PHP", "Ruby"],
    "data_science": ["Machine Learning", "Deep Learning", "Data Science", "AI", "NLP", "Computer Vision"],
    "web_frontend": ["React", "Vue", "Angular", "HTML", "CSS", "Next.js", "Svelte"],
    "web_backend":  ["Django", "FastAPI", "Spring Boot", "Node.js", "Express", "Laravel"],
